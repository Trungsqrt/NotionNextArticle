...
/** @deprecated Use getNotionPageData instead */
export const getNotionPageHtml = cache(async function getNotionPageHtml(pageId) {
  const { html } = await getNotionPageData(pageId)
  return html
})
